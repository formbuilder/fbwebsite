...
<tr valign="middle"><td align="left"><font face="arial,helvetica">Supply</td><td><font face="arial,helvetica"><select multiple="multiple" name="supply" type="select"><option selected="selected" value="0">0</option><option selected="selected" value="1">1</option><option selected="selected" value="2">2</option><option selected="selected" value="3">3</option><option selected="selected" value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr>
<tr valign="middle"><td align="left"><font face="arial,helvetica">Demand</td><td><font face="arial,helvetica"><select multiple="multiple" name="demand" type="select"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option selected="selected" value="5">5</option><option selected="selected" value="6">6</option><option selected="selected" value="7">7</option><option selected="selected" value="8">8</option><option selected="selected" value="9">9</option></select></td></tr>
...
<tr valign="middle"><td colspan="2"><center><input name="_reset" type="reset" value="Reset" /><input name="_submit" type="submit" value="Submit" /></center></td></tr></table>
...

    {
        ...
        res => q(<form action="00generate.t" method="GET"><input name="_submitted" type="hidden" value="1" /><input name="_sessionid" type="hidden" value="" /><table>
<tr valign="middle"><td align="left">Earth =&gt;</td><td><input name="earth" type="text" /></td></tr>
<tr valign="middle"><td align="left">Wind &gt;&gt;</td><td><input name="wind" type="radio" value="&lt;Slow&gt;" /> &lt;Slow&gt; <input name="wind" type="radio" value="&lt;Medium&gt;" /> &lt;Medium&gt; <input name="wind" type="radio" value="&lt;Fast&gt;" /> &lt;Fast&gt; </td></tr>
<tr valign="middle"><td align="left">&quot;Fire&quot;</td><td><select name="fire" type="select"><option value="">-select-</option><option value="&amp;&amp;MURDEROUS&quot;">&amp;&amp;MURDEROUS&quot;</option><option value="&amp;&amp;HOT&quot;">&amp;&amp;HOT&quot;</option><option value="&amp;&amp;WARM&quot;">&amp;&amp;WARM&quot;</option><option value="&amp;&amp;COLD&quot;">&amp;&amp;COLD&quot;</option><option value="&amp;&amp;CHILLY&quot;">&amp;&amp;CHILLY&quot;</option><option value="&amp;&amp;OUT&quot;">&amp;&amp;OUT&quot;</option></select></td></tr>
