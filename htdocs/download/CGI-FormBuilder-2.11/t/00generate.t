...
<tr valign="middle"><td colspan="2"><center><input name="_reset" type="reset" value="Reset"><input onClick="this.form._submit.value = this.value;" name="_submit" type="submit" value="Update"><input onClick="this.form._submit.value = this.value;" name="_submit" type="submit" value="Delete"><input onClick="this.form._submit.value = this.value;" name="_submit" type="submit" value="Cancel"></center></td></tr></table>
</form>),
    },
