...
Used for checkboxes and radio buttons. If you have a field with many
options, the checkboxes and/or radio buttons can easily clutter up your
form. Use the columns argument to evenly spread them over just as many
columns:
...
$Id: FormBuilder.pod,v 2.13 2004/08/11 21:15:46 nwiger Exp nwiger $

=head1 AUTHOR

Copyright (c) 2001-2004 Nathan Wiger, Sun Microsystems <nate@sun.com>.
All Rights Reserved.
